...
<div class="card h-100 rounded-4">
  ...
  <div class="row gy-2 justify-content-center align-items-center p-3 h-100">
    <div class="col-12 col-sm-6 col-lg-5">
      <?= Html::a(
        Html::img(isset($model->orderItems[0]->product->productImages[0]) ?
          Product::IMG_PATH . $model->orderItems[0]->product->productImages[0]->photo : Product::NO_PHOTO, ['class' => 'col-6 col-lg-12 h-100 h-sm-auto']) .
    ...
    <div class="col-12 col-sm-6 col-lg-7 d-flex flex-column align-items-center justify-content-between gap-2">
